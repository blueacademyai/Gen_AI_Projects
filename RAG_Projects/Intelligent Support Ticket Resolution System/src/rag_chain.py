...
class SupportRAGChain:
    ...
    def __init__(self, vector_store: SupportVectorStore):
        ...
        self.prompt_template = ChatPromptTemplate.from_messages([
            ("system", """You are a helpful support assistant. Use the provided support ticket 
            context to answer the user's question. If the context doesn't contain enough 
            information to answer fully, say so. Focus on providing clear, actionable solutions.
            Don't repeat the same information from the context. Do not respond from your knowledge, 
